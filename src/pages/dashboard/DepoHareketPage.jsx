...
export default function DepoHareketPage() {
  ...
  // Not: Bu ekranda hareket SİLME bilinçli olarak yok — silme yalnızca
  // Kağıt sayfasındaki Son Girişler/Son Çıkışlar listesinden yapılır
  // (tek yerden, yanlışlıkla kalıcı kayıt kaybını önlemek için).
