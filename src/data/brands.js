import atlasLogo from "../assets/images/portfolyo/1.svg";
...
export const BRAND_LOGOS = [
  ...
  {
    id: "meridian",
    name: "Meridian Lojistik",
    logo: createLogo("#0f172a", "#34d399"),
  },
  {
    id: "sterling",
    name: "Sterling Finans",
    logo: createLogo("#0b1120", "#f472b6"),
  },
  { id: "kule", name: "Kule Yapı", logo: createLogo("#020617", "#fb7185") },
  {
    id: "horizon",
    name: "Horizon Medya",
    logo: createLogo("#0f172a", "#c084fc"),
  },
  {
    id: "lumen",
    name: "Lumen Dijital",
    logo: createLogo("#0a0f1e", "#22d3ee"),
  },
  {
    id: "prizma",
    name: "Prizma Sağlık",
    logo: createLogo("#020617", "#fbbf24"),
  },
  {
    id: "delta",
    name: "Delta Teknoloji",
    logo: createLogo("#0f172a", "#4ade80"),
  },
  {
    id: "aurum",
    name: "Aurum Tekstil",
    logo: createLogo("#0b1120", "#f97316"),
  },
  { id: "tarla", name: "Tarla Gıda", logo: createLogo("#0f172a", "#a3e635") },
  {
    id: "zenith",
    name: "Zenith Turizm",
    logo: createLogo("#020617", "#f472b6"),
  },
];
