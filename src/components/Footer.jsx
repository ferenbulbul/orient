    ...
    <footer className="w-full bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid gap-10 md:grid-cols-3 md:items-start">
          ...
          <div className="text-sm text-slate-300 md:justify-self-end md:text-right">
            ...
            <p>
              {isEN
                ? 'Address: IKITELLI OSB MAH. GIYIM SANATKARLARI 5A-6A BLOK No: 315 - 304, 34490 BASAKSEHIR / ISTANBUL'
